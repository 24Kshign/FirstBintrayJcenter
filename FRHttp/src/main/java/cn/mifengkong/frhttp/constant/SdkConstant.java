package cn.mifengkong.frhttp.constant;
...
public class SdkConstant {
    ...
    public static final String CLOUDAPI_X_Ca_Request_Mod = "X-Ca-Request-Mode";
    //请求 API的Stage
    public static final String CLOUDAPI_X_CA_STAGE = "X-Ca-Stage";
