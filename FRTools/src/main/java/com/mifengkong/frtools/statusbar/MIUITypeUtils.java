...
import com.mifengkong.frtools.permission.GoToPermissionSetting;
...
/**
 * Created by jiangyongxing on 2017/7/4.
 * 描述：
 */
...
//        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        if (isIntentAvailable(intent, context)) {
            context.startActivityForResult(intent, GoToPermissionSetting.REQUEST_CODE_PERMISSION_SETTING);
        } else {
