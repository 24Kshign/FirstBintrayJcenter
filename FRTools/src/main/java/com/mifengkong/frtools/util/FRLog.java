...
public final class FRLog {
    ...
    // tr
    public static int verbose(Throwable tr) {
        return log(Log.VERBOSE, null, "", tr);
    }

    public static int debug(Throwable tr) {
        return log(Log.DEBUG, null, "", tr);
    }

    public static int info(Throwable tr) {
        return log(Log.INFO, null, "", tr);
    }

    public static int warn(Throwable tr) {
        return log(Log.WARN, null, "", tr);
    }

    public static int error(Throwable tr) {
        return log(Log.ERROR, null, "", tr);
    }

    // msg, tr
    public static int verbose(String msg, Throwable tr) {
        return log(Log.VERBOSE, null, msg, tr);
    }

    public static int debug(String msg, Throwable tr) {
        return log(Log.DEBUG, null, msg, tr);
    }

    public static int info(String msg, Throwable tr) {
        return log(Log.INFO, null, msg, tr);
    }

    public static int warn(String msg, Throwable tr) {
        return log(Log.WARN, null, msg, tr);
    }

    public static int error(String msg, Throwable tr) {
    ...
    // 无参数
    public static int verboseEx(int stackLevel) {
        return logEx(Log.VERBOSE, "", null, stackLevel);
    }

    public static int debugEx(int stackLevel) {
        return logEx(Log.DEBUG, "", null, stackLevel);
    }

    public static int infoEx(int stackLevel) {
        return logEx(Log.INFO, "", null, stackLevel);
    }

    public static int warnEx(int stackLevel) {
        return logEx(Log.WARN, "", null, stackLevel);
    }

    public static int errorEx(int stackLevel) {
        return logEx(Log.ERROR, "", null, stackLevel);
    }

    // msg
    public static int verboseEx(String msg, int stackLevel) {
        return logEx(Log.VERBOSE, msg, null, stackLevel);
    }

    public static int debugEx(String msg, int stackLevel) {
        return logEx(Log.DEBUG, msg, null, stackLevel);
    }

    public static int infoEx(String msg, int stackLevel) {
        return logEx(Log.INFO, msg, null, stackLevel);
    }

    public static int warnEx(String msg, int stackLevel) {
        return logEx(Log.WARN, msg, null, stackLevel);
    }

    public static int errorEx(String msg, int stackLevel) {
        return logEx(Log.ERROR, msg, null, stackLevel);
    }

    // tr
    public static int verboseEx(Throwable tr, int stackLevel) {
        return logEx(Log.VERBOSE, "", tr, stackLevel);
    }

    public static int debugEx(Throwable tr, int stackLevel) {
        return logEx(Log.DEBUG, "", tr, stackLevel);
    }

    public static int infoEx(Throwable tr, int stackLevel) {
        return logEx(Log.INFO, "", tr, stackLevel);
    }

    public static int warnEx(Throwable tr, int stackLevel) {
        return logEx(Log.WARN, "", tr, stackLevel);
    }

    public static int errorEx(Throwable tr, int stackLevel) {
        return logEx(Log.ERROR, "", tr, stackLevel);
    }

    // tr
    public static int verboseEx(String msg, Throwable tr, int stackLevel) {
        return logEx(Log.VERBOSE, msg, tr, stackLevel);
    }

    public static int debugEx(String msg, Throwable tr, int stackLevel) {
        return logEx(Log.DEBUG, msg, tr, stackLevel);
    }

    public static int infoEx(String msg, Throwable tr, int stackLevel) {
        return logEx(Log.INFO, msg, tr, stackLevel);
    }

    public static int warnEx(String msg, Throwable tr, int stackLevel) {
        return logEx(Log.WARN, msg, tr, stackLevel);
    }

    public static int errorEx(String msg, Throwable tr, int stackLevel) {
    ...
    private static int logImpl(int logLevel, String tag, String msg, Throwable tr) {
        String logTag = FRLog.class.getSimpleName() + "-" + tag;
        String logMsg;
        if (tr != null) {
            logMsg = FRString.valueOf(msg) + " \n" + Log.getStackTraceString(tr);
        } else {
            logMsg = FRString.valueOf(msg);
        }
    ...
    private static int logImpl(int logLevel, StackTraceElement stackTraceElement, String msg, Throwable tr) {
        return logImpl(logLevel, stackTraceElement.getClassName(),
                stackTraceElement.getMethodName() + "(), Line " + stackTraceElement.getLineNumber() + ". " + FRString.valueOf(msg), tr);
    }
}
